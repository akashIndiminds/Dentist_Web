...
export default function Services() {
  ...
  const whatsappMessage = "Hi Doctor, I want to know more about your dental services."
  ...
  const services = [
    {
      ...
      description: 'Complete dental care for families including cleanings and fillings.',
      icon: Shield,
  ...
  return (
    <section id="services" className="py-8 md:py-12 lg:py-20 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-8 md:mb-12">
          <div className="inline-flex items-center px-3 py-1.5 bg-blue-100 rounded-full mb-3 md:mb-4">
            ...
            <span className="text-xs md:text-sm font-medium text-blue-700">Our Services</span>
          </div>
          ...
          <p className="text-sm md:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed px-2">
            Complete dental care using <span className="font-semibold text-blue-600">latest technology</span>.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-8 md:mb-12">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                {/* Background Pattern */}
                <div className={`absolute top-0 right-0 w-12 sm:w-16 md:w-20 h-12 sm:h-16 md:h-20 bg-gradient-to-br ${service.bgGradient} rounded-full opacity-20 transform translate-x-4 sm:translate-x-6 -translate-y-4 sm:-translate-y-6`}></div>
                
                {/* Icon */}
                <div className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-gradient-to-r ${service.gradient} rounded-lg md:rounded-xl flex items-center justify-center mb-3 md:mb-4 group-hover:scale-105 transition-all duration-300 shadow-md relative z-10`}>
        ...
        <div className="text-center">
          <div className="bg-white rounded-xl md:rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-lg border border-gray-100 max-w-lg md:max-w-2xl mx-auto">
            <div className="flex items-center justify-center mb-3 md:mb-4">
              ...
              <span className="text-blue-600 font-semibold text-xs md:text-sm lg:text-base">Premium Care</span>
            </div>
