...
export default function About() {
  ...
  const whatsappMessage = "Hi Doctor, I want to know more about your dental practice."
  ...
  return (
    <section id="about" className="py-8 md:py-12 lg:py-20 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
          ...
          <div className="space-y-6 lg:space-y-8">
            <div>
              <div className="inline-flex items-center px-3 md:px-4 py-1.5 md:py-2 bg-blue-100 rounded-full mb-4 md:mb-6">
                ...
                <span className="text-xs md:text-sm font-medium text-blue-700">Premium Dental Care</span>
              </div>
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed mb-4 md:mb-6">
                ...
                provides highest quality dental services in a comfortable, modern environment. 
                Our practice combines <span className="font-semibold text-blue-700">advanced technology</span> with personalized care.
              </p>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
                We specialize in general dentistry and oral surgery, from routine cleanings to complex surgical interventions. 
                Our goal is optimal oral health and the beautiful smile you&apos;ve always wanted.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
              {highlights.map((highlight, index) => (
                <div key={index} className="flex items-center space-x-3 p-3 md:p-4 rounded-lg md:rounded-xl hover:bg-white/70 hover:shadow-md transition-all duration-300">
                  <div className="p-2 bg-blue-100 rounded-lg flex-shrink-0">
                    <CheckCircle className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />
                  </div>
                  <span className="text-sm md:text-base text-gray-700 font-medium">{highlight}</span>
                </div>
              ))}
            </div>
          ...
          <div className="relative order-first lg:order-last">
              ...
              <div className="aspect-[3/2] sm:aspect-[4/3] lg:aspect-[4/5] bg-gradient-to-br from-blue-100 to-blue-50 rounded-xl md:rounded-2xl flex items-center justify-center relative overflow-hidden shadow-lg md:shadow-xl">
                ...
                <div className="text-center relative z-10">
                  ...
                  <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-32 md:h-32 lg:w-40 lg:h-40 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full mx-auto mb-2 md:mb-4 flex items-center justify-center shadow-lg transform hover:scale-105 transition-transform duration-300">
                    <span className="text-white text-lg sm:text-xl md:text-4xl lg:text-5xl font-bold">Dr</span>
                  </div>
                  <div className="bg-white/90 px-3 md:px-4 py-1.5 md:py-2 rounded-lg md:rounded-xl shadow-md">
                    <p className="text-gray-600 font-medium text-xs md:text-sm">Dr. Rajat Majumdar</p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2 md:gap-4 mt-4 md:mt-6 lg:mt-8">
              {stats.map((stat, index) => {
                ...
                return (
                  <div key={index} className="group bg-white rounded-lg md:rounded-xl p-3 md:p-4 lg:p-6 shadow-md hover:shadow-lg text-center transition-all duration-300 transform hover:scale-105">
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-1">{stat.number}</div>
